                            ...
                            <div class="col ">
                                <div class="row">
                                    ...
                                    <div className='col-lg-5 mb-3'>
                                        <input onChange={handleUserChange} value={user} name="name" id="name" type="text"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div className='col-lg-4 mb-3'>
                                        <label class="mont-font fw-700 font-xssss">Contraseña </label>
                                    </div>
                                    <div className='col-lg-5 mb-3'>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 mb-3">
                                        <label class="text-left mont-font fw-800 font-xssss">Sucursal </label>
                                    </div>
                                    <div class="col-lg-5 mb-3">
                                        <select onChange={handleSucursalChange} value={sucursal} type="text" class="mont-font fw-600 font-xsss" required >
                                ...
                                <div className='col-lg-12 mt-3'>                                    
                                    {/* <Link to={{pathname: "/Home", state: {user: {user}}}}> */}
                                        <Button style={{
                                            ...
                                            fontSize: "12px",
                                            color: "white",
                                            }} variant='contained' onClick={() => {handlerInput() }}>
                                            Iniciar sesión
                                        </Button>  
                                    {/* </Link>                                   */}
                                </div>
