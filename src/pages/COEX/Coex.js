...
import { Button } from "@material-ui/core";
import PickerDateTime from "../../components/Appointments/PickerDoctor";
import PickerDoctor from "../../components/Appointments/PickerDoctor";
import TableCrud from "../../components/Tables/TableCrud";
import TableCrud2 from "../../components/Tables/TableCrud2";

export default function Coex() {
  return (
    <Fragment>
      <HeaderAdmision />
            ...
            <div className="row">
              <div className="col-xl-12 cart-wrapper mb-4">
                <div class="row pt-5">
                  <div class="col-sm-12">
                    <div class="card bg-greyblue border-0 p-4 mb-5">
                      <p class="mb-0 mont-font font-xssss text-uppercase fw-600 text-grey-500">
                        ...
                        <a class="expand-btn text-grey-500 fw-900" href="/Coex">
                          {" "}
                          Coex
                        </a>
                      </p>
                  ...
                  <h4 class="mont-font fw-600 font-md pt-3 pb-3">COEX</h4>
