...
export default function OrdenesMedicasV() {
	useEffect(() => {
	...
	const Antecedentes = {
		...
		ordenesmedicas3: 'Canaliza vena periferal con “angio cath” con solución.',
		ordenesmedicas4: 'Iniciar medidas de resucitación cardiopulmonar.',
		diagnostico1:
			'Neurologico: Despierto alerta cooperador, ancamado, debilidad de extremidades toracicas a expensas de la derecha la cual no realiza presion.',
	};
							...
							<div className='col-xl-12 cart-wrapper mb-4'>
								<div class='row pt-5'>
									...
									<table className='tablita'>
										<thead>
											<tr>
												<th className='fw-900 font-xs'>Ordenes Médicas</th>
												<th className='fw-900'>Fecha</th>
												<th className='fw-900'>Creada por</th>
												<th className='fw-900 text-mid'>
										...
										<tbody>
											<tr>
												...
												<td>12/02/2022</td>
												<td>Médico Turno</td>
												<td className='center-table-content'>
													<input type='checkbox' />
												</td>
											</tr>
											<tr>
												<td className='font-xss'>
													{Antecedentes.ordenesmedicas2}
													{/* {propsData && (
						...
						<div
							...
							<Link
								...
								<Button
									fullWidth
									variant='contained'>
									<i className='feather-save'> GUARDAR</i>
								</Button>
							</Link>
						</div>
					</div>
