                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="row">  
                                    <FormControl className='col-lg-4 ms-3 pt-3'>
                                        <InputLabel id="demo-simple-select-label">Listado de imagénes diagnósticas</InputLabel>
                                        <Select
                                        labelId="demo-simple-select-label"
                                        id="demo-simple-select">
                                            <MenuItem value="value1">Rayos X</MenuItem>
                                            <MenuItem value="value2">Tomografías computarizadas</MenuItem>
                                            <MenuItem value="value3">Estudios de medicina nuclear</MenuItem>
                                            <MenuItem value="value4">Imágenes por resonancia magnética</MenuItem>
                                    ...
                                    <FormControl className='col-lg-4 ms-3 pt-3'>
                                        ...
                                        id="demo-simple-select">
                                            ...
                                            <MenuItem value="value5">Extremidades superiores</MenuItem>
                                            <MenuItem value="value5">Extremidades inferiores</MenuItem>
                                        </Select>
                                        
                                    </FormControl> 
                                    <FormControl className='col-lg-2 ms-3 pt-3'>
                                        <InputLabel id="demo-simple-select-label">Sub-región</InputLabel>
                                        <Select
                                        labelId="demo-simple-select-label"
                                        id="demo-simple-select">
