...
export default function ModalAseguradoras() {
    ...
    const options = ['','','','','', ];
    const zonas = ['Salud Siempre','Aseguradora General','Seguros El Roble','Seguros G&T','Provesa','BI Empresarial','Empresa Electrica',];
    ...
    return (
        <div>
            <Button variant="contained" color="warning" onClick={handleOpen}>
                Ingresar información de aseguradora
            </Button>
            <Modal
                        ...
                        <CardActionArea>
                            ...
                            {/* <div class="row">
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        ...
                                        <Autocomplete
                                                ...
                                                options={lugarpob}
                                                sx={{ width: 300 }}
                                                renderInput={(params) => <TextField {...params} label="Tipo de póliza" />}
                                            />
                                        </div>        
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="form-gorup">
                                            <label class="mont-font fw-600 font-xssss">Número de póliza:</label>
                                            <input type="text" name="comment-name" class="form-control" />
                                        </div>        
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="form-gorup">
                                            <label class="mont-font fw-600 font-xssss">Número de certificado:</label>
                                            <input type="text" name="comment-name" class="form-control" />
                                        </div>        
                                    </div>
                                </div>
                            <Link to="/Admisiones"><Button variant="contained">Guardar</Button></Link>
                            </CardContent>
                        </CardActionArea>
                    </Card>
                </div>
