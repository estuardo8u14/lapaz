            ...
            <div className="nav-content">
              ...
              <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-1 mt-1">
                ...
                <ul className="mb-1 top-content">
                  ...
                  <li>
                    <Link to="/Tablas" className="nav-content-bttn open-font">
                  ...
                  <li>
                    <Link to="/Motivo" className="nav-content-bttn open-font">
                      <i className="feather-file-text btn-round-md bg-blue-gradiant me-3"></i>
                  ...
                  <li>
                    <Link to="/HistEnf" className="nav-content-bttn open-font">
                      <i className="feather-file-text btn-round-md bg-blue-gradiant me-3"></i>
                  ...
                  <li>
                    <Link to="/Notas" className="nav-content-bttn open-font">
                      <i className="feather-file-text btn-round-md bg-blue-gradiant me-3"></i>
                  ...
                  <li>
                    <Link to="/Ordenes" className="nav-content-bttn open-font">
                      <i className="feather-file-text btn-round-md bg-blue-gradiant me-3"></i>
                  ...
                  <li>
                    <Link to="/Dx" className="nav-content-bttn open-font">
                      <i className="feather-file-text btn-round-md bg-blue-gradiant me-3"></i>
