    ...
    render() {
        ...
        return (
            <div className="nav-header bg-white shadow-xs border-0">
                ...
                <form action="#" className="barritacontenedor">
                ...
                <nav className={`navigation scroll-bar ${navClass}`}>
                    <div className="container ps-0 pe-0">
                        ...
                        <div className="row bg-black-gradient col-lg-13">
                            <div className='heart'><div className="col-lg-10 mb-3 mt-3">
                                <div className="card p-md-3 p-3 bg-black-gradient rounded-2 shadow-xss bg-pattern border-0 overflow-hidden">
                                    <div className="bg-pattern"></div>
                                    <h2 className="fw-700 font-xs text-white mb-0 mt-0">Juan Pérez <span className="fw-700 ls-0 text-black-500 font-xssss mt-0 d-block">Código del paciente: 301947968</span></h2>
                                    <p className="fw-700 text-white mb-0 mt-0"> <span className="fw-700 ls-0 text-black-500 font-xsssss mt-0 d-block">Código admisión: CL-3462023</span></p>
                                    ...
                                    <p className=" fw-700 text-white mb-0 mt-0"><p className="fw-700 ls-0 text-black-500 font-xsssss mt-0 d-block">Fecha actual: (Y-d-m)</p></p>
                                </div>
                            </div></div>
                            </div>
                            <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-1 mt-1">
                                <div className='row mb-3'>
                                    <form action="#" className="float-left header-search ms-3">
                                        <div className="form-group mb-0 icon-input">
                                            <i className="feather-search font-sm text-grey-400"></i>
                                            <input type="text" placeholder="Buscar en servicios..." className="bg-grey border-0 lh-32 pt-2 pb-2 ps-5 pe-3 font-xssss fw-500 rounded-xl w200 theme-dark-bg" />
                                        </div>
                                    </form>
                                </div>
                                <div className="nav-caption fw-600 font-xssss text-grey-500"><span>Página </span>Principal Admisiones</div>
                                <ul className="mb-1 top-content">
                                    <li className="logo d-none d-xl-block d-lg-block"></li>
                                    <li><Link to="/Admisiones" className="nav-content-bttn open-font"><i className="feather-plus btn-round-md bg-blue-gradiant me-3"></i><span>Nuevo Paciente</span></Link></li>
                                    <li><Link to="/Tablas" className="nav-content-bttn open-font"><i className="feather-user btn-round-md bg-blue-gradiant me-3"></i><span>Paciente</span></Link></li>
                                    <li><Link to="/Admision" className="nav-content-bttn open-font"><i className="feather-users btn-round-md bg-blue-gradiant me-3"></i><span>Admisión Nueva</span></Link></li>
