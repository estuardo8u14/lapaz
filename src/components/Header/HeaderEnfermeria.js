                        ...
                        <div className="nav-content">
                            <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-1 mt-1">
                                ...
                                <ul className="mb-1 top-content">
                                    ...
                                    <li><Link to="/Enfermeria" className="nav-content-bttn open-font"><i className="feather-user-check btn-round-md bg-mini-gradiant me-3"></i><span>Revisión de ordenes</span></Link></li>
                                    <li><Link to="/Signos" className="nav-content-bttn open-font"><i className="feather-activity btn-round-md bg-mini-gradiant me-3"></i><span>Signos Vitales</span></Link></li>
                                </ul>
                            </div>
