            ...
            <div className="nav-content">
                ...
                <div className="card p-md-3 p-3 bg-black-gradient rounded-2 shadow-xss bg-pattern border-0 overflow-hidden">
                  ...
                  <h2 className="fw-700 font-xs text-white mb-0 mt-0">
                    ...
                    <span className="fw-700 ls-0 text-black-500 font-xssss mt-0 d-block">
                      Código del paciente: 319743890101
                    </span>
                  </h2>
              ...
              <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-1 mt-1">
                <div className="nav-caption fw-600 font-xssss text-grey-500">
                  <span>Página </span>Principal Paciente
                </div>
                <ul className="mb-1 top-content">
                  ...
                  <li>
                    <Link to="/Perfil" className="nav-content-bttn open-font">
                  ...
                  <li>
                    <Link to="/" className="nav-content-bttn open-font">
                      <i className="feather-git-branch btn-round-md bg-blue-gradiant me-3"></i>
                      <span>Laboratorio</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/" className="nav-content-bttn open-font">
                      <i className="feather-eye btn-round-md bg-blue-gradiant me-3"></i>
                      <span>Diagnosticos</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/" className="nav-content-bttn open-font">
                      <i className="feather-alert-octagon btn-round-md bg-blue-gradiant me-3"></i>
                      <span>SOP</span>
                    </Link>
                  </li>
                  <li>
