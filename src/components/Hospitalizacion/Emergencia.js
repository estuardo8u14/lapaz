            ...
            <div class="col-xl-12 mt-5">
                <div class="page-title">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="row">  
                                    <FormControl className='col-lg-5 ms-3 pt-3'>
                                        <InputLabel id="demo-simple-select-label">Número de cubículo asignado</InputLabel>
                                        <Select
                                        labelId="demo-simple-select-label"
                                        id="demo-simple-select">
                                            <MenuItem value="value1">Cubículo 1</MenuItem>
                                            <MenuItem value="value2">Cubículo 2</MenuItem>
                                            <MenuItem value="value3">Cubículo 3</MenuItem>
                                            <MenuItem value="value4">Cubículo 4</MenuItem>
                                            <MenuItem value="value5">Cubículo 5</MenuItem>
                                            <MenuItem value="value6">Cubículo 6</MenuItem>
                    ...
                    <h4 class="mont-font fw-600 font-md mb-0 pt-1">Cargar archivos</h4>
                                            ...
                                            <h4 class="mont-font fw-600 font-md mb-2 pt-3">Compromiso de pago</h4>
                                            <form action="#">                       
                                                <div class="row">
                                                        <div class="col-lg-12 mb-3">
                                          ...
                                          <h4 class="mont-font fw-600 font-md mb-2">Consentimiento informado</h4>
                                            <form action="#">                       
                                                <div class="row">
